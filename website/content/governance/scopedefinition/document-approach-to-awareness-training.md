...
description: "Define the scope and content of security awareness training including topics, audiences, delivery methods, and compliance tracking."
date: 2024-01-01
draft: false
...
<div class="governance-hero">
  ...
  <circle cx="12" cy="12" r="2"/>
            ...
            <h1 class="hero-title">Document Approach to Awareness Training</h1>
            <nav class="breadcrumb">
                <a href="/governance/" class="breadcrumb-link">Governance</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/governance/scopedefinition/" class="breadcrumb-link">Scope Definition</a>
            </nav>
            
            <p class="hero-description">Define the scope and content of security awareness training including topics, audiences, delivery methods, and compliance tracking.</p>
...
<div class="governance-item-content">
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Define the scope and content of security awareness training including topics, audiences, delivery methods, and compliance tracking.</p>
                    </div>
                </section>
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Document Approach to Awareness Training</p>
                    </div>
                </section>
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <div class="notes-content">
                            ...
                            <p>- Covering: - Security DOs and DON'Ts - Using strong authentication factors - Protecting authentication factors - Not to reuse previously used factors - Change factors if there is suspicion there maybe be a compromise - Report incident if compromise is suspected - Phishing - Social engineering - Acceptable use - POS device management [if in-scope]</p>
                    ...
                    <div class="section-content">
                        <div class="related-items">
                            <div class="related-item">
                                <a href="/governance/scopedefinition/" class="related-link">
  ...
  <circle cx="12" cy="12" r="2"/>
                                    ...
                                    <div class="related-text">
                                        <span class="related-title">Browse Scope Definition</span>
  ...
  <circle cx="12" cy="12" r="3"/>
            ...
            <aside class="sidebar">
                <div class="sidebar-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value">G.ScopeDefinition.Awareness</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Category</span>
                            <span class="info-value">Scope Definition</span>
                        </div>
                        <div class="info-item">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="nav-links">
                        <a href="/governance/scopedefinition/" class="nav-link">
  ...
  <circle cx="12" cy="12" r="2"/>
                            ...
                            <span class="nav-text">Scope Definition</span>
                        </a>
