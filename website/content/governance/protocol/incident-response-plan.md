...
description: "Comprehensive incident response procedures including detection, analysis, containment, eradication, recovery, and lessons learned processes."
date: 2024-01-01
draft: false
...
<div class="governance-hero">
  ...
  <path d="M8 18l4 4 4-4"/>
            ...
            <h1 class="hero-title">Incident Response Plan</h1>
            <nav class="breadcrumb">
                <a href="/governance/" class="breadcrumb-link">Governance</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/governance/protocol/" class="breadcrumb-link">Protocols</a>
            </nav>
            
            <p class="hero-description">Comprehensive incident response procedures including detection, analysis, containment, eradication, recovery, and lessons learned processes.</p>
...
<div class="governance-item-content">
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Comprehensive incident response procedures including detection, analysis, containment, eradication, recovery, and lessons learned processes.</p>
                    </div>
                </section>
                    ...
                    <div class="section-content">
                        <div class="notes-content">
                            ...
                            <ul class="notes-list">
                                ...
                                <li>- actions are taken for disruptions in security controls - Roles and responsibilities - Contacts and communication strategies - Notification to payment brands and acquirers</li>
                                
                                <li>if needed - Business recovery and continuity process</li>
                                
                                <li>including backups - Legal requirements for reporting compromises or breaches - PCI: PAN or SAD found where it shouldn't be</li>
                    ...
                    <div class="section-content">
                        <div class="related-items">
                            <div class="related-item">
                                <a href="/governance/protocol/" class="related-link">
  ...
  <path d="M8 18l4 4 4-4"/>
                                    ...
                                    <div class="related-text">
                                        <span class="related-title">Browse Protocols</span>
  ...
  <circle cx="12" cy="12" r="3"/>
            ...
            <aside class="sidebar">
                <div class="sidebar-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value">G.Protocol.IncidentResponsePlan</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Category</span>
                            <span class="info-value">Protocols</span>
                        </div>
                        <div class="info-item">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="nav-links">
                        <a href="/governance/protocol/" class="nav-link">
