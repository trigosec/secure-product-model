...
<div class="governance-hero">
  ...
  <path d="M8 18l4 4 4-4"/>
            ...
            <p class="hero-subtitle">Step-by-step operational procedures and methodologies for implementing security practices.</p>
            <p class="hero-description">
                Explore 3 governance items in this category. Each item provides specific guidance
                for implementing protocols within your security program.
            </p>
        </div>
    </div>
</div>
...
<div class="governance-grid-section">
    <div class="container">
        <h2 class="section-title">Protocols Items</h2>
  ...
  <path d="M8 18l4 4 4-4"/>
                    ...
                    <div class="stat-content">
                        ...
                        <p class="stat-label">Protocols Items</p>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon"><svg viewBox="0 0 24 24" width="80" height="80" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg">
...
<div class="governance-footer-section">
    <div class="container">
        <div class="footer-content">
            <h2>Ready to implement protocols?</h2>
            <p>These 3 protocols items provide comprehensive guidance for building a robust security program that meets compliance requirements and protects your organization.</p>
            <div class="footer-stats">
                <div class="footer-stat">
                    <strong>3</strong>
                    <span>Protocols Items</span>
                </div>
                <div class="footer-stat">
                    <strong>30</strong>
