...
description: "Comprehensive security policy establishing the organization's security program, roles, responsibilities, and overall security strategy. Serves as the ..."
date: 2024-01-01
draft: false
...
<div class="governance-hero">
  ...
  <polyline points="10,9 9,9 8,9"/>
            ...
            <nav class="breadcrumb">
                ...
                <a href="/governance/policy/" class="breadcrumb-link">Policies</a>
            </nav>
            
            <p class="hero-description">Comprehensive security policy establishing the organization's security program, roles, responsibilities, and overall security strategy. Serves as the foundation for all other security policies.</p>
...
<div class="governance-item-content">
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Comprehensive security policy establishing the organization's security program, roles, responsibilities, and overall security strategy. Serves as the foundation for all other security policies.</p>
                    </div>
                </section>
                    ...
                    <div class="section-content">
                        <div class="notes-content">
                            ...
                            <ul class="notes-list">
                                ...
                                <li>- CISO or other exec</li>
                                
                                <li>explicitely accountable for security - updates within year if risk environment changes - Roles and responsibilities (PCI) - Locations - System components - Segmentation controls - Connection to 3rd parties - Security strategy</li>
                                
                                <li>including: - how technology support compliance with PCI DSS - remediations to outdate tech - RACI matrix included in policy</li>
                    ...
                    <div class="section-content">
                        <div class="related-items">
                            <div class="related-item">
                                <a href="/governance/policy/" class="related-link">
  ...
  <polyline points="10,9 9,9 8,9"/>
                                    ...
                                    <div class="related-text">
                                        <span class="related-title">Browse Policies</span>
  ...
  <circle cx="12" cy="12" r="3"/>
            ...
            <aside class="sidebar">
                <div class="sidebar-card">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value">G.Policy.Security</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Category</span>
                            <span class="info-value">Policies</span>
                        </div>
                        <div class="info-item">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="nav-links">
                        <a href="/governance/policy/" class="nav-link">
