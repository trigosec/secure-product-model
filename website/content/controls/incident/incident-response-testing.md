...
date: 2024-01-01
draft: false
control_id: "C.Incident.Testing"
control_category: "incident"
---
...
<div class="control-hero">
  ...
  <circle cx="19" cy="6" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">Incident response testing</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/incident/" class="breadcrumb-link">Incident Response</a>
            </nav>
