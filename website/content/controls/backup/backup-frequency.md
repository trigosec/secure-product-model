...
description: "Depending on data classification or resource type, environment"
date: 2024-01-01
draft: false
control_id: "C.Backup.Frequency"
...
<div class="control-hero">
  ...
  <path d="M14 16.5v5" stroke="currentColor" stroke-width="2"/>
            ...
            <h1 class="hero-title">Backup frequency</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/backup/" class="breadcrumb-link">Backup & Recovery</a>
            </nav>
            
            <p class="hero-description">Depending on data classification or resource type, environment</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Depending on data classification or resource type, environment</p>
                    </div>
                </section>
