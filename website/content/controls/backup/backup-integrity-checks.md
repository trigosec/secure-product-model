---
title: "Backup integrity checks"
description: "To confirm the data stored is correct"
date: 2024-01-01
draft: false
control_id: "C.Backup.Integrity"
...
<div class="control-hero">
  ...
  <path d="M14 16.5v5" stroke="currentColor" stroke-width="2"/>
            ...
            <h1 class="hero-title">Backup integrity checks</h1>
            ...
            <p class="hero-description">To confirm the data stored is correct</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>To confirm the data stored is correct</p>
                    </div>
                </section>
