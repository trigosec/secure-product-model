...
description: "Controls for email security, anti-phishing measures, and email authentication protocols."
date: 2024-01-01
draft: false
weight: 10
---
...
<div class="governance-hero">
  ...
  <path d="M6 12l2 2 4-4" stroke="currentColor" stroke-width="1.5" fill="none"/>
            ...
            <h1 class="hero-title">Email Security</h1>
            <p class="hero-subtitle">Controls for email security, anti-phishing measures, and email authentication protocols.</p>
            <p class="hero-description">
                Explore 3 governance items in this category. Each item provides specific guidance
                for implementing email security within your security program.
            </p>
        </div>
    </div>
</div>
...
<div class="governance-grid-section">
    <div class="container">
        <h2 class="section-title">Email Security Items</h2>
  ...
  <path d="M6 12l2 2 4-4" stroke="currentColor" stroke-width="1.5" fill="none"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/mail/e-mail-dkim/">E-Mail DKIM</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/mail/e-mail-dkim/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M6 12l2 2 4-4" stroke="currentColor" stroke-width="1.5" fill="none"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/mail/e-mail-dmarc/">E-Mail DMARC</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/mail/e-mail-dmarc/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M6 12l2 2 4-4" stroke="currentColor" stroke-width="1.5" fill="none"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/mail/e-mail-spf/">E-Mail SPF</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/mail/e-mail-spf/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M6 12l2 2 4-4" stroke="currentColor" stroke-width="1.5" fill="none"/>
                    ...
                    <div class="stat-content">
                        ...
                        <p class="stat-label">Email Security Items</p>
                    </div>
                </div>
                <div class="stat-card">
...
<div class="governance-footer-section">
    <div class="container">
        <div class="footer-content">
            <h2>Ready to implement email security?</h2>
            <p>These 3 email security items provide comprehensive guidance for building a robust security program that meets compliance requirements and protects your organization.</p>
            <div class="footer-stats">
                <div class="footer-stat">
                    <strong>3</strong>
                    <span>Email Security Items</span>
                </div>
                <div class="footer-stat">
                    <strong></strong>
