...
description: "On a regular basis (yearly, bi-yearly, ...) Including: contract + updates"
date: 2024-01-01
draft: false
control_id: "C.ThirdParty.Monitoring"
control_category: "thirdparty"
---
...
<div class="control-hero">
  ...
  <path d="M3 12h6" stroke="currentColor" stroke-width="1.5"/>
            ...
            <h1 class="hero-title">Third Party Monitoring</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/thirdparty/" class="breadcrumb-link">Third-Party Risk</a>
            </nav>
            
            <p class="hero-description">On a regular basis (yearly, bi-yearly, ...) Including: contract + updates</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>On a regular basis (yearly, bi-yearly, ...) Including: contract + updates</p>
                    </div>
                </section>
