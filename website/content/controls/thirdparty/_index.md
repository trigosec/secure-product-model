...
description: "Controls for third-party risk management, vendor assessments, and supply chain security."
date: 2024-01-01
draft: false
weight: 10
---
...
<div class="governance-hero">
  ...
  <path d="M3 12h6" stroke="currentColor" stroke-width="1.5"/>
            ...
            <h1 class="hero-title">Third-Party Risk</h1>
            <p class="hero-subtitle">Controls for third-party risk management, vendor assessments, and supply chain security.</p>
            <p class="hero-description">
                Explore 2 governance items in this category. Each item provides specific guidance
                for implementing third-party risk within your security program.
            </p>
        </div>
    </div>
</div>
...
<div class="governance-grid-section">
    <div class="container">
        <h2 class="section-title">Third-Party Risk Items</h2>
  ...
  <path d="M3 12h6" stroke="currentColor" stroke-width="1.5"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/thirdparty/due-diligence-prior-to-engagement/">Due diligence prior to engagement</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/thirdparty/due-diligence-prior-to-engagement/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M3 12h6" stroke="currentColor" stroke-width="1.5"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/thirdparty/third-party-monitoring/">Third Party Monitoring</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/thirdparty/third-party-monitoring/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M3 12h6" stroke="currentColor" stroke-width="1.5"/>
                    ...
                    <div class="stat-content">
                        ...
                        <p class="stat-label">Third-Party Risk Items</p>
                    </div>
                </div>
                <div class="stat-card">
...
<div class="governance-footer-section">
    <div class="container">
        <div class="footer-content">
            <h2>Ready to implement third-party risk?</h2>
            <p>These 2 third-party risk items provide comprehensive guidance for building a robust security program that meets compliance requirements and protects your organization.</p>
            <div class="footer-stats">
                <div class="footer-stat">
                    <strong>2</strong>
                    <span>Third-Party Risk Items</span>
                </div>
                <div class="footer-stat">
                    <strong></strong>
