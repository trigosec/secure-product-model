...
description: "For each system, validate that logs are being monitored. Including: - Access to cardholder data - Access to the audit logs (read-only) - Failed login ..."
date: 2024-01-01
draft: false
control_id: "C.Logs.Availability"
...
<div class="control-hero">
  ...
  <circle cx="18" cy="15" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">Log availability</h1>
            ...
            <p class="hero-description">For each system, validate that logs are being monitored. Including: - Access to cardholder data - Access to the audit logs (read-only) - Failed login attempts - Actions related to the user life cycle (creation, updates, deletion) - Actions that change user credentials - Changes to audit log acquisition (starting, stopping/pausing) - Changes to OS configuration - Network logs</p>
