...
description: "Recording for each event: - User identification. - Type of event. - Date and time. - Success and failure indication. - Origination of event. - Identit..."
date: 2024-01-01
draft: false
control_id: "C.Logs.Monitor"
control_category: "logs"
---
...
<div class="control-hero">
  ...
  <circle cx="18" cy="15" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">Log Monitoring</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/logs/" class="breadcrumb-link">Logging & Monitoring</a>
            </nav>
            
            <p class="hero-description">Recording for each event: - User identification. - Type of event. - Date and time. - Success and failure indication. - Origination of event. - Identity or name of affected data, system component, resource, or service</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Recording for each event: - User identification. - Type of event. - Date and time. - Success and failure indication. - Origination of event. - Identity or name of affected data, system component, resource, or service</p>
                    </div>
                </section>
