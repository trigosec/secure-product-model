---
title: "No hardcoded secrets in code, CI/CD pipelines"
description: "Monitor source code, specially deployment scripts to avoid the usage of hardcoded credentials"
date: 2024-01-01
draft: false
control_id: "C.Code.NoHardcodedSecrets"
control_category: "code"
---
...
<div class="control-hero">
  ...
  <path d="M18 5v2" stroke="currentColor" stroke-width="1"/>
            ...
            <h1 class="hero-title">No hardcoded secrets in code, CI/CD pipelines</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/code/" class="breadcrumb-link">Code Security</a>
            </nav>
            
            <p class="hero-description">Monitor source code, specially deployment scripts to avoid the usage of hardcoded credentials</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Monitor source code, specially deployment scripts to avoid the usage of hardcoded credentials</p>
                    </div>
                </section>
