---
title: "Untrusted office network"
description: "No special connections or ports, no configuration on the network hardward apart from the minimal required to give internet access"
date: 2024-01-01
draft: false
control_id: "C.Network.UntrustedOffice"
...
<div class="control-hero">
  ...
  <circle cx="12" cy="12" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">Untrusted office network</h1>
            ...
            <p class="hero-description">No special connections or ports, no configuration on the network hardward apart from the minimal required to give internet access</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>No special connections or ports, no configuration on the network hardward apart from the minimal required to give internet access</p>
                    </div>
                </section>
