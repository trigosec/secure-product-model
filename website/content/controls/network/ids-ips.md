---
title: "IDS/IPS"
description: "Ideally: - Network, including IDS/IPS outsourced to cloud provider Alternative: - check logs are monitored for the relevant networks - tickets are act..."
date: 2024-01-01
draft: false
control_id: "C.Network.IntrusionDetectionPrevention"
...
<div class="control-hero">
  ...
  <circle cx="12" cy="12" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">IDS/IPS</h1>
            ...
            <p class="hero-description">Ideally: - Network, including IDS/IPS outsourced to cloud provider Alternative: - check logs are monitored for the relevant networks - tickets are actioned</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Ideally: - Network, including IDS/IPS outsourced to cloud provider Alternative: - check logs are monitored for the relevant networks - tickets are actioned</p>
                    </div>
                </section>
