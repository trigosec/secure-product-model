---
title: "Network: Deny by default"
description: "Based on network inventory, identify the egress points and confirm that the default rule in the firewalls is to deny all traffic"
date: 2024-01-01
draft: false
control_id: "C.Network.DenyByDefault"
...
<div class="control-hero">
  ...
  <circle cx="12" cy="12" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">Network: Deny by default</h1>
            ...
            <p class="hero-description">Based on network inventory, identify the egress points and confirm that the default rule in the firewalls is to deny all traffic</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Based on network inventory, identify the egress points and confirm that the default rule in the firewalls is to deny all traffic</p>
                    </div>
                </section>
