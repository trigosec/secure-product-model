---
title: "VPN access for non-public services"
description: "Don't expose to the internet services that are supposed to be internal only"
date: 2024-01-01
draft: false
control_id: "C.Network.VPN"
...
<div class="control-hero">
  ...
  <circle cx="12" cy="12" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">VPN access for non-public services</h1>
            ...
            <p class="hero-description">Don't expose to the internet services that are supposed to be internal only</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Don't expose to the internet services that are supposed to be internal only</p>
                    </div>
                </section>
