---
title: "Non-PCI resources shouldn't access directly PCI resources, but use the internet"
description: "Segmentation testing: PCI vs non-PCI Network scans on a schedule, testiing for access from non-pci resources to pci resources Alternatively: use the C..."
date: 2024-01-01
draft: false
control_id: "C.Network.SegmentationPCI"
...
<div class="control-hero">
  ...
  <circle cx="12" cy="12" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">Non-PCI resources shouldn't access directly PCI resources, but use the internet</h1>
            ...
            <p class="hero-description">Segmentation testing: PCI vs non-PCI Network scans on a schedule, testiing for access from non-pci resources to pci resources Alternatively: use the Cloud Network Inventory to analyse network routes</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Segmentation testing: PCI vs non-PCI Network scans on a schedule, testiing for access from non-pci resources to pci resources Alternatively: use the Cloud Network Inventory to analyse network routes</p>
                    </div>
                </section>
