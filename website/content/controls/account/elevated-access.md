...
description: "Ideally: elevated access is temporal Independently, monitoring for: - access - Actions performed All captured in logs, triggering security events"
date: 2024-01-01
draft: false
control_id: "C.Account.ElevatedAccess"
...
<div class="control-hero">
  ...
  <path d="M15 19v-1a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1" stroke="currentColor" stroke-width="1.5" fill="none"/>
            ...
            <h1 class="hero-title">Elevated access</h1>
            ...
            <p class="hero-description">Ideally: elevated access is temporal Independently, monitoring for: - access - Actions performed All captured in logs, triggering security events</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Ideally: elevated access is temporal Independently, monitoring for: - access - Actions performed All captured in logs, triggering security events</p>
                    </div>
                </section>
