---
title: "PCI: Encryption of keys used to encrypt data"
description: "- At least as strong encryption as the data encryption keys - Stored separately from data-encryption keys, in Hardware Security Module (HSM) or PIN Tr..."
date: 2024-01-01
draft: false
control_id: "C.PCI.KeyEncryption"
control_category: "pci"
---
...
<div class="control-hero">
  ...
  <circle cx="13" cy="9" r="1" fill="currentColor"/>
            ...
            <h1 class="hero-title">PCI: Encryption of keys used to encrypt data</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/pci/" class="breadcrumb-link">PCI Compliance</a>
            </nav>
            
            <p class="hero-description">- At least as strong encryption as the data encryption keys - Stored separately from data-encryption keys, in Hardware Security Module (HSM) or PIN Transaction Security (PTS) device</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>- At least as strong encryption as the data encryption keys - Stored separately from data-encryption keys, in Hardware Security Module (HSM) or PIN Transaction Security (PTS) device</p>
                    </div>
                </section>
