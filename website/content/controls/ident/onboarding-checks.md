...
description: "Previous employment history, public information/social media, criminal records, credit history, reference checks"
date: 2024-01-01
draft: false
control_id: "C.Ident.OnboardingChecks"
control_category: "ident"
---
...
<div class="control-hero">
  ...
  <path d="M19 7v2" stroke="currentColor" stroke-width="1.5"/>
            ...
            <h1 class="hero-title">Onboarding checks</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/ident/" class="breadcrumb-link">Identity Management</a>
            </nav>
            
            <p class="hero-description">Previous employment history, public information/social media, criminal records, credit history, reference checks</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Previous employment history, public information/social media, criminal records, credit history, reference checks</p>
                    </div>
                </section>
