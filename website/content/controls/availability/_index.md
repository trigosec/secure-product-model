...
description: "Controls ensuring system uptime, redundancy, and disaster recovery capabilities."
date: 2024-01-01
draft: false
weight: 10
---
...
<div class="governance-hero">
  ...
  <path d="M17.5 19l1 1 2-2" stroke="currentColor" stroke-width="2" fill="none"/>
            ...
            <h1 class="hero-title">High Availability</h1>
            <p class="hero-subtitle">Controls ensuring system uptime, redundancy, and disaster recovery capabilities.</p>
            <p class="hero-description">
                Explore 2 governance items in this category. Each item provides specific guidance
                for implementing high availability within your security program.
            </p>
        </div>
    </div>
</div>
...
<div class="governance-grid-section">
    <div class="container">
        <h2 class="section-title">High Availability Items</h2>
  ...
  <path d="M17.5 19l1 1 2-2" stroke="currentColor" stroke-width="2" fill="none"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/availability/multi-az/">Multi-AZ</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/availability/multi-az/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M17.5 19l1 1 2-2" stroke="currentColor" stroke-width="2" fill="none"/>
                ...
                <div class="card-body">
                    <h3 class="card-title">
                        <a href="/governance/availability/multi-region/">Multi-region</a>
                    </h3>
                    
                </div>
                <div class="card-footer">
                    <a href="/governance/availability/multi-region/" class="card-link">View Details →</a>
                </div>
            </div>
  ...
  <path d="M17.5 19l1 1 2-2" stroke="currentColor" stroke-width="2" fill="none"/>
                    ...
                    <div class="stat-content">
                        ...
                        <p class="stat-label">High Availability Items</p>
                    </div>
                </div>
                <div class="stat-card">
...
<div class="governance-footer-section">
    <div class="container">
        <div class="footer-content">
            <h2>Ready to implement high availability?</h2>
            <p>These 2 high availability items provide comprehensive guidance for building a robust security program that meets compliance requirements and protects your organization.</p>
            <div class="footer-stats">
                <div class="footer-stat">
                    <strong>2</strong>
                    <span>High Availability Items</span>
                </div>
                <div class="footer-stat">
                    <strong></strong>
