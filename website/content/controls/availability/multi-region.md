---
title: "Multi-region"
description: "Resilience control through the use of a multi-region setup - IF Active-Active: Traffic analysis at the ingress points should show traffic on both regi..."
date: 2024-01-01
draft: false
control_id: "C.Availability.MultiRegion"
...
<div class="control-hero">
  ...
  <path d="M17.5 19l1 1 2-2" stroke="currentColor" stroke-width="2" fill="none"/>
            ...
            <h1 class="hero-title">Multi-region</h1>
            <nav class="breadcrumb">
                <a href="/controls/" class="breadcrumb-link">Controls</a>
                <span class="breadcrumb-separator">→</span>
                <a href="/controls/availability/" class="breadcrumb-link">High Availability</a>
            </nav>
            
            <p class="hero-description">Resilience control through the use of a multi-region setup - IF Active-Active: Traffic analysis at the ingress points should show traffic on both regions - ELSE: Traffic failover is automated and tested on a schedule (quarterly, every 6 months, yearly)</p>
            ...
            <main class="main-content">
                ...
                <section class="content-section">
                    ...
                    <div class="section-content">
                        <p>Resilience control through the use of a multi-region setup - IF Active-Active: Traffic analysis at the ingress points should show traffic on both regions - ELSE: Traffic failover is automated and tested on a schedule (quarterly, every 6 months, yearly)</p>
                    </div>
                </section>
            ...
            <aside class="sidebar">
                <div class="sidebar-card">
                    ...
                    <div class="no-frameworks">
                        <p style="color: #666; font-style: italic;">No specific compliance frameworks identified</p>
                    </div>
